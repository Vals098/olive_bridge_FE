...
function AdminProductForm() {
  ...
  const [editedFields, setEditedFields] = useState<Partial<ProductRequest>>({})
  ...
  const productFormData: ProductRequest | null =
    isEditMode && selectedProduct && selectedProduct.productId === productId
      ? {
          ...
          technicalInformationId:
            selectedProduct.technicalInformation.technicalInformationId,
          ...editedFields,
        }
      : null

  const currentFormData = isEditMode ? productFormData : formData
  ...
  const handleSubmit = async (event: SyntheticEvent) => {
    ...
    if (isEditMode && productId && currentFormData) {
      await dispatch(updateAdminProduct(productId, currentFormData))
    } else {
  ...
  return (
    <main className="admin-product-form-page">
      <Container>
        ...
        <Card className="admin-product-form-card">
          <Card.Body>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <Form.Group className="mb-3">
                ...
                <div className="d-flex gap-2">
                  <Form.Select
                    name="categoryId"
                    value={currentFormData?.categoryId ?? ""}
                    onChange={handleChange}
                    required
                  >
              ...
              <Form.Group className="mb-4">
                ...
                <div className="d-flex gap-2">
                  <Form.Select
                    ...
                    value={currentFormData?.technicalInformationId ?? ""}
                    onChange={handleChange}
                    required
                  >
                    ...
                    {technicalInformations.map((technicalInformation) => (
                      ...
                      >
                        Acidity: {technicalInformation.acidity} | Peroxide:{" "}
                        {technicalInformation.peroxideValue} | Harvest:{" "}
